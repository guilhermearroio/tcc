    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-5 d-flex align-items-center justify-content-center" style="background-color: var(--main-purple-light);height: 100vh;">
                                ...
                                <form action="Controllers/RegisterController.php" method="POST" class="ongForm mt-2 needs-validation" novalidate>
                                    ...
                                    <div class="step secondStep row invisibleStep">
                                        ...
                                        <div class="col-12 col-md-2 my-2">
                                            ...
                                            <input type="text" name="numero" class="form-control" id="numeroLabel" placeholder="" aria-label="Número" required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-12 col-md-4 my-2">
                                            ...
                                            <input type="text" name="bairro" class="form-control" id="bairroLabel" placeholder="" aria-label="Bairro" required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-12 col-md-6 my-2">
                                            ...
                                            <input type="text" name="cidade" class="form-control" id="cidadeLabel" placeholder="" aria-label="Cidade" required>
                                            <div class="invalid-feedback">
                    ...
                    <div class="item item-form mt-5 mt-md-0">
                        <div class="block-form d-flex flex-column">
                            ...
                            <div class="col-12">
                                ...
                                <form action="Controllers/RegisterController.php" method="POST" class="row g-3 ongForm mt-2 needs-validation" novalidate>
                                        <div class="step firstStep row">
                                            <div class="col-12 px-md-0 my-2">
                                                <label for="cnpjLabel">CNPJ</label>
                                                <input type="text" name="nome" class="form-control" id="cnpjLabel" placeholder="CNPJ" aria-label="CNPJ" required>
                                                <div class="invalid-feedback">
                                                    Por favor preencher com um CNPJ válido
                                        ...
                                        <div class="step secondStep row invisibleStep">
                                            ...
                                            <div class="col-12 col-md-12 ps-md-0 my-2">
                                                <label for="logradouroLabel">Logradouro</label>
                                                <input type="text" name="logradouro" class="form-control" id="logradouroLabel" placeholder="Logradouro" aria-label="Logradouro" required>
                                                <div class="invalid-feedback">
                                                    Por favor preencher o Logradouro
